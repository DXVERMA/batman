...
# all the above codes for lecture 3
# here we are registering our UserFctory class that we have created in factories 
from pytest_factoryboy import register
from tests.factories import UserFactory , ProductFactory,CategoryFactory

register(UserFactory) #user_factory will be used by our fixtuers 
